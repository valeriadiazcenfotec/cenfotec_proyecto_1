document.addEventListener("DOMContentLoaded", () => {
    ...
    const campos = {
        ...
        descripcion: {
            ...
            validar: valor => valor.trim() !== "" && valor.length <= 100,
            mensaje: "La descripción es obligatoria y debe tener máximo 100 caracteres."
        },
        categoria: {
        ...
        imagenNegocio: {
            ...
            mensaje: "Debe subir una imagen de la oferta."
        }
    };
    ...
    formulario.addEventListener("submit", function (e) {
        ...
        Object.entries(campos).forEach(([key, { element, validar, mensaje }]) => {
            const esValido = validar(key === "imagenNegocio" ? null : element.value);
            mostrarError(element, esValido ? "" : mensaje);
